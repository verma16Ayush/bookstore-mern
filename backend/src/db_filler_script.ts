...
const data = [
  ...
  {
    "title": "Fall of the House of Usher, The (Zánik domu Usheru)",
  ...
  {
    "title": "Général Idi Amin Dada: A Self Portrait (Général Idi Amin Dada: Autoportrait)",
  ...
  {
    "title": "Dillinger Is Dead (Dillinger è morto)",
  ...
  {
    "title": "Farewell, My Queen (Les adieux à la reine)",
  ...
  {
    "title": "Perched on a Tree (Sur un arbre perché)",
  ...
  {
    "title": "In the Beginning (À l'Origine)",
  ...
  {
    "title": "Vääpeli Körmy - Taisteluni",
  ...
  {
    "title": "Dragon Ball Z: Fusion Reborn (Doragon bôru Z 12: Fukkatsu no fyushon!! Gokû to Bejîta)",
  ...
  {
    "title": "Who Wants to Kill Jessie? (Kdo chce zabít Jessii?)",
  ...
  {
    "title": "Kautokeino Rebellion, The (Kautokeino-opprøret)",
  ...
  {
    "title": "Happily Ever After (Ils se marièrent et eurent beaucoup d'enfants)",
  ...
  {
    "title": "Left-Hand Side of the Fridge, The (Moitié gauche du frigo, La)",
  ...
  {
    "title": "Stoplight Society, The (La Sociedad del Semáforo)",
